class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:username, :password, :password_confirmation, :email, :name, :surname, :identification, :gender, :birthday, :cellphone, :pin, :city, :terms_of_service)
  end
