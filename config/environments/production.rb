Lafunda::Application.configure do
  ...
  config.serve_static_assets = false #true for heroku
  ...
  config.assets.compile = false #true for heroku
  ...
  config.action_mailer.default_url_options = { host: 'www.lafunda.com.do' }
